...
const HeroHomeContact: FC = () => {
  return (
    <div className="contactusimage">
      <div className="w-[95%] md:h-[80vh] flex flex-col lg:flex-row justify-end items-center opacity-90 bg-primary-blue">
        <div className="flex flex-col lg:flex-row justify-between w-[97%] h-[70vh]">
          <div className="w-full lg:w-[65%] h-auto lg:h-[60vh] mb-8 lg:mb-0">
            <div className="w-full h-auto lg:h-[70vh]">
              ...
              <div className="flex flex-col gap-6 h-auto lg:h-[49vh] w-full justify-center">
                <div className="flex  gap-5 w-full sm:flex-row">
                  <input type="text" placeholder="Enter Your First Name" className="h-[7vh] w-full sm:w-[50%] text-[1.4rem] text-primary-black rounded-lg border-none outline-none px-4 focus:bg-primary-orange focus:text-primary-white" />
                  <input type="text" placeholder="Enter Your Last Name" className="h-[7vh] w-full sm:w-[50%] text-[1.4rem] text-primary-black rounded-lg border-none outline-none px-4 focus:bg-primary-orange focus:text-primary-white" />
                </div>
                <div className="flex  gap-5 w-full sm:flex-row">
                  <input type="text" placeholder="Enter Your Phone Number" className="h-[7vh] w-full sm:w-[50%] text-[1.4rem] text-primary-black rounded-lg border-none outline-none px-4 focus:bg-primary-orange focus:text-primary-white" />
                  <input type="text" placeholder="Enter Your Email Address" className="h-[7vh] w-full sm:w-[50%] text-[1.4rem] text-primary-black rounded-lg border-none outline-none px-4 focus:bg-primary-orange focus:text-primary-white" />
                </div>
          ...
          <div className="w-full lg:w-[35%] h-auto lg:h-[70vh] relative">
            <div className="w-full lg:w-[40%] h-auto lg:h-[70vh] flex flex-col justify-between lg:ml-10">
            ...
            <div className="absolute w-full lg:w-[88%] h-auto lg:h-[65vh] bg-primary-orange top-3 right-0 z-10 flex flex-col rounded-lg">
              ...
              <div className="flex flex-col justify-around gap-5 h-auto lg:h-[50vh]">
                <div className="flex justify-center items-center py-3 md:py-0 px-5 gap-8 w-full">
                  <div className="flex justify-center items-center h-[5rem] w-[5rem] bg-primary-darkblue rounded-full">
                    <AiOutlineInfoCircle className="text-primary-white md:text-[4rem] text:[2rem]" />
                  </div>
                ...
                <a href="tel:03335561099" className="flex gap-6 items-center px-5 py-3 md:py-0 w-full no-underline">
                  <div className="flex justify-center items-center h-[5rem] w-[5rem] bg-primary-darkblue rounded-full lg:ml-12">
                    <AiOutlineInfoCircle className="text-primary-white  md:text-[4rem] text:[2rem]" />
                  </div>
                  <div className="flex flex-col w-full lg:w-[50%]">
