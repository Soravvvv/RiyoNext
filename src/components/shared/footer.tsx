  ...
  const Footer: React.FC = () => {
    ...
    return (
      <div className="p-[2%] bgpresence bg-gradient-to-b from-primary-blue to-primary-orange relative z-30">
        <div className="flex w-full justify-evenly items-end text-primary-white">
          <div className="w-[35%]">
          ...
          <div className="h-[11rem] w-px bg-primary-white"></div>

          <div className="mt-6 p-2 h-[15rem]">
            <h1 className="cursor-pointer text-primary-white text-3xl" onClick={toggleMainLinks}>Main Links</h1>
            <div className='mt-4'>
          ...
          <div className="mt-6 p-2 h-[15rem]">
            <h1 className="cursor-pointer text-primary-white text-3xl" onClick={toggleQuickLinks}>Quick Links</h1>
            <div className='mt-4'>
          ...
          <div className="mt-6 p-2 h-[15rem]">
            <h1 className="cursor-pointer text-primary-white text-3xl" onClick={toggleSupportLinks}>Support</h1>
            <div className='mt-4'>
